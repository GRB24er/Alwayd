              ...
              <div className={styles.card}>
                ...
                <div className={styles.cardBody}>
                  ...
                  <div className={styles.orderSummary}>
                    ...
                    <div className={styles.summaryRow}>
                      <span>Price</span>
                      <span>{format(marketData.AAPL.price)}</span>
                    </div>
                    <div className={styles.summaryTotal}>
                      <span>Estimated Total</span>
                      <span className={styles.totalAmount}>{format(Number(calculateOrderTotal()))}</span>
                    </div>
                  </div>
                ...
                <div className={styles.cardBody}>
                  <div className={styles.marketDataGrid}>
                    <div className={styles.dataItem}>
                      ...
                      <span className={styles.dataValue}>{format(marketData.AAPL.price)}</span>
                    </div>
                    <div className={styles.dataItem}>
                    ...
                    <div className={styles.dataItem}>
                      ...
                      <span className={styles.dataValue}>{format(marketData.AAPL.high)}</span>
                    </div>
                    <div className={styles.dataItem}>
                      <span className={styles.dataLabel}>Day Low</span>
                      <span className={styles.dataValue}>{format(marketData.AAPL.low)}</span>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <tbody>
                        {portfolio.map((holding, idx) => (
                          <tr key={idx}>
                            ...
                            <td className={styles.valueCol}>{format(holding.value)}</td>
                    ...
                    {recentTrades.map(trade => (
                      <div key={trade.id} className={styles.tradeItem}>
                        ...
                        <div className={styles.tradeRight}>
                          <div className={styles.tradeTotal}>{format(trade.total)}</div>
