                        ...
                        <div className={styles.approvalSection}>
                          ...
                          <div className={styles.approvalGrid}>
                            <div className={styles.approvalItem}>
                              ...
                              <span className={styles.approvalValue}>{format(app.workflow.approval.creditLimit || 0)}</span>
                            </div>
                            <div className={styles.approvalItem}>
                            ...
                            <div className={styles.approvalItem}>
                              ...
                              <span className={styles.approvalValue}>{format(app.workflow.approval.annualFee || 0)}</span>
                            </div>
                            <div className={styles.approvalItem}>
