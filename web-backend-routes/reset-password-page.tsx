...
//
// Fixes the 404 from the sign-in page's "Recover Access" button, which
// routes to /auth/reset-password.
//
// Also copy reset-password-page.module.css to:
//   src/app/auth/reset-password/reset.module.css
//
// Flow: email → 6-digit emailed code + new password → success.
// Uses POST /api/auth/forgot-password and POST /api/auth/reset-password
// (see forgot-password.route.ts and reset-password.route.ts).
    ...
    <div className={styles.container}>
      <div className={styles.card}>
        <div className={styles.logoContainer}>
          ...
          <img src="/logo.png" alt="Aldwych European Capital" className={styles.logo} onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
        </div>
